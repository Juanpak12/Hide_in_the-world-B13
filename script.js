...
const chosenPlayersWithDepartmentList = document.getElementById(
  "chosen-players-with-department"
);

// Función para resaltar el departamento seleccionado en el mapa
function highlightDepartment(selectedDepartment) {
  const selectedDepartmentElement = document.getElementById(
...
>>>>>>> b616eb26689276b160e9e091493f217e3cd7e77f
}
